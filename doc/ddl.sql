...
CREATE TABLE dor_vod_col (
    ...
    vod_pic VARCHAR(255) COMMENT '视频图片',
    vod_actor varchar(255) comment '演员列表',
    vod_director VARCHAR(128) comment '导演',
    vod_content text COMMENT '视频内容',
    vod_lang varchar(64) comment '视频语言',
    vod_time datetime comment '视频上映时间',
    vod_state varchar(64) comment '视频情况, 连载中/已完结',
    vod_remarks varchar(64) comment '视频情况, 更新到xx',
    vod_area varchar(64) comment '视频地域',
    PRIMARY KEY (id),
